                ...
                <br>
                    ...
                    <form action="{{ route('produit.update',$produit->id) }}" method="POST">
                        ...
                        @csrf
                            ...
                            <div class="col-sm-10">
                            <input type="text"  class="form-control" name="designation:" value={{ $produit->designation }} id="" class="form-control" placeholder="" aria-describedby="helpId">
                        </div>
                        </div>
                        <div class="form-group">
                            <label for="">Prix</label>
                            <input type="text" name="prix" id="" value={{ $produit->prix }} class="form-control" placeholder="" aria-describedby="helpId">
